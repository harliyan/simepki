...
class Subindikator extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->session->userdata('username') == NULL) {
            ...
            $data['tsubindikator'] = $this->db->query(
                "SELECT `tsubindikator`.*, `tindikator`.`indikator`, `tindikator`.`kdlokasi`, `tlokasi`.`nmlokasi`, `tlokasi`.`singkatan_lokasi` FROM tsubindikator INNER JOIN tindikator ON `tsubindikator`.kdindikator = `tindikator`.kdindikator INNER JOIN tlokasi ON `tindikator`.kdlokasi = `tlokasi`.kdlokasi ORDER BY `tsubindikator`.`id` ASC;"
            )->result_array();

            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/header', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('subindikator/tsubindikator_list', $data);
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $kdsubindikator = $this->input->post('kdsubindikator', TRUE);
            $this->db->query("INSERT INTO tlaporan (kdsubindikator) VALUES ($kdsubindikator); ");
