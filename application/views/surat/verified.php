    ...
    <div class="col-span-12 2xl:col-span-12">
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-4">
                <h2 class="font-medium text-center text-lg">Surat Diverifikasi</h2>
                <h3 class="text-gray-600 text-center mt-2 mb-4">Daftar Surat yang Sudah Diperiksa Verifikator Tetapi Belum Dilegitimasi oleh Legitimator</h3>
                        ...
                        <?php foreach ($draft as $d) : ?>
                            <tr>
                                ...
                                <td width="180" class="text-center">
                                    ...
                                    <a href="" class="btn btn-sm btn-elevated-danger mt-2"> Tanda Tangan Manual</a>
                                </td>
                            </tr>
                            <?php $i++; ?>
                        <?php endforeach; ?>
