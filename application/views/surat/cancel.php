    ...
    <div class="col-span-12 2xl:col-span-12">
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-4">
                <h2 class="font-medium text-center text-lg">Surat Dibatalkan</h2>
                <h3 class="text-gray-600 text-center mt-2 mb-4">Daftar Surat yang Telah Dibatalkan oleh Operator Kelurahan</h3>
