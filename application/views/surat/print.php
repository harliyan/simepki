    ...
    <div class="col-span-12 2xl:col-span-12">
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-4">
                <h2 class="font-medium text-center text-lg">Surat Selesai</h2>
                <h3 class="text-gray-600 text-center mt-2 mb-4">Daftar Surat yang Sudah Ditanda Tangan Elektronik dan Siap Dicetak</h3>
