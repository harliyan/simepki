<div class="intro-y grid grid-cols-12 sm:gap-6 gap-y-6 box px-5 py-8 mt-5">
    <div class="intro-y col-span-12 flexjustify-center">
        ...
        <div class="text-xl font-medium text-center">CETAK LAPORAN</div>
    </div>
                ...
                <?php foreach ($instalasi as $d) : ?>
                    <tr>
                        ...
                        <td style="text-align:center" width="120px">
                            <a href="<?php echo site_url('cetaklaporan/cetak/' . $d['kdlokasi']) ?>" class="btn btn-sm btn-elevated-primary"><i data-lucide="paperclip" class="w-4 h-4"></i> Cetak Laporan</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
