<form action="<?php echo $action; ?>" method="post">
    ...
    <div class="form-group mt-2 mb-4">
        <select class="form-control" name="kdlokasi" id="kdlokasi">
            <option value="0">== PILIH INSTALASI ==</option>
            <?php foreach ($instalasi as $each) { ?>
                <option value="<?php echo $each['kdlokasi']; ?>"><?php echo $each['nmlokasi']; ?> (<?php echo $each['singkatan_lokasi']; ?>)</option>
            <?php } ?>
        </select>
    </div>
